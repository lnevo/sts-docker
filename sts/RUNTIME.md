...
| Track scale (addon) | Not on this branch (`workflow-editor`). Present on `active` / `track-scale` as `plugins/track_scale/`. Recipe weigh/calibrate steps skip when the plugin is absent. |
